...
static inline void IOMUXC_SetPinMux(uint32_t muxRegister,
		...
		uint32_t inputDaisy,
		__attribute__((unused)) uint32_t configRegister,
 ...
 */
static inline void IOMUXC_SetPinConfig(__attribute__((unused))   uint32_t muxRegister,
		__attribute__((unused))  uint32_t muxMode,
		__attribute__((unused))  uint32_t inputRegister,
		__attribute__((unused))  uint32_t inputDaisy,
