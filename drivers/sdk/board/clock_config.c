...
- {id: ENET2_TX_CLK.outFreq, value: 25 MHz}
- {id: ENET_125M_CLK.outFreq, value: 125 MHz}
- {id: ENET_25M_REF_CLK.outFreq, value: 25 MHz}
- {id: FLEXIO1_CLK_ROOT.outFreq, value: 30 MHz}
- {id: FLEXIO2_CLK_ROOT.outFreq, value: 30 MHz}
- {id: FLEXSPI2_CLK_ROOT.outFreq, value: 9504/29 MHz}
- {id: FLEXSPI_CLK_ROOT.outFreq, value: 9504/29 MHz}
...
- {id: TRACE_CLK_ROOT.outFreq, value: 126.72 MHz}
- {id: UART_CLK_ROOT.outFreq, value: 80 MHz}
- {id: USBPHY1_CLK.outFreq, value: 480 MHz}
- {id: USBPHY2_CLK.outFreq, value: 24 MHz}
- {id: USDHC1_CLK_ROOT.outFreq, value: 190.08 MHz}
- {id: USDHC2_CLK_ROOT.outFreq, value: 190.08 MHz}
settings:
...
- {id: CCM_ANALOG.PLL2_PFD0_DIV.scale, value: '25', locked: true}
- {id: CCM_ANALOG.PLL2_PFD0_MUL.scale, value: '18', locked: true}
- {id: CCM_ANALOG.PLL2_PFD1_BYPASS.sel, value: CCM_ANALOG.PLL2_PFD1}
- {id: CCM_ANALOG.PLL2_PFD1_DIV.scale, value: '16', locked: true}
- {id: CCM_ANALOG.PLL2_PFD1_MUL.scale, value: '18', locked: true}
...
- {id: CCM_ANALOG.PLL3_PFD0_DIV.scale, value: '25', locked: true}
- {id: CCM_ANALOG.PLL3_PFD0_MUL.scale, value: '18', locked: true}
- {id: CCM_ANALOG.PLL3_PFD1_BYPASS.sel, value: CCM_ANALOG.PLL3_PFD1}
- {id: CCM_ANALOG.PLL3_PFD1_DIV.scale, value: '27'}
- {id: CCM_ANALOG.PLL3_PFD2_BYPASS.sel, value: CCM_ANALOG.PLL3_PFD2}
- {id: CCM_ANALOG.PLL3_PFD3_BYPASS.sel, value: CCM_ANALOG.PLL3_PFD3}
- {id: CCM_ANALOG.PLL3_PFD3_DIV.scale, value: '16', locked: true}
- {id: CCM_ANALOG.PLL3_PFD3_MUL.scale, value: '18', locked: true}
- {id: CCM_ANALOG.PLL3_PREDIV.scale, value: '1', locked: true}
- {id: CCM_ANALOG.PLL3_VDIV.scale, value: '20', locked: true}
- {id: CCM_ANALOG.PLL4.denom, value: '960000'}
- {id: CCM_ANALOG.PLL4.div, value: '28'}
- {id: CCM_ANALOG.PLL4.num, value: '1'}
...
- {id: XTALOSC24M_OSC_CONFIG2_MUX_1M_CFG, value: Enabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
...
#warning "SKIP_SYSCLK_INIT should be defined to keep system pll (selected to be SEMC source clock in SDK projects) unchanged."
    ...
    /* Init System pfd0. */
    CLOCK_InitSysPfd(kCLOCK_Pfd0, 25);
    /* Init System pfd1. */
    ...
    /* Init Usb1 pfd0. */
    CLOCK_InitUsb1Pfd(kCLOCK_Pfd0, 25);
    /* Init Usb1 pfd1. */
    CLOCK_InitUsb1Pfd(kCLOCK_Pfd1, 27);
    /* Init Usb1 pfd2. */
    CLOCK_InitUsb1Pfd(kCLOCK_Pfd2, 17);
    /* Init Usb1 pfd3. */
    CLOCK_InitUsb1Pfd(kCLOCK_Pfd3, 16);
#endif
    /* Init Audio PLL. */
    uint32_t pllAudio;
    ...
    CCM_ANALOG->PLL_AUDIO_NUM = CCM_ANALOG_PLL_AUDIO_NUM_A(1);
    CCM_ANALOG->PLL_AUDIO_DENOM = CCM_ANALOG_PLL_AUDIO_DENOM_B(960000);
    pllAudio = (CCM_ANALOG->PLL_AUDIO & (~(CCM_ANALOG_PLL_AUDIO_DIV_SELECT_MASK | CCM_ANALOG_PLL_AUDIO_POWERDOWN_MASK))) |
               CCM_ANALOG_PLL_AUDIO_ENABLE_MASK | CCM_ANALOG_PLL_AUDIO_DIV_SELECT(28);
